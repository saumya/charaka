...
export default {
    name: "HomeSchedule",
    components: { ScheduleForm, ScheduleSearchForm },
    computed: {
        ...mapGetters(['get_general_message'])
    },
    data: function(){
        return({
            ui_message: 'Welcome to Schedule Management. This section allows you to CREATE, READ, UPDATE, DELETE schedules.',
            section_visibility:{
                ui_create: 'none',
                ui_read: 'none',
                ui_update: 'none',
